...
./config.sh --unattended --url https://github.com/tosin2013/kcli-pipelines --token "$KCLI_PIPELINES_GITHUB_TOKEN" --labels "self-hosted,Linux,X64" --name "${GUID}-github-runner" --replace
