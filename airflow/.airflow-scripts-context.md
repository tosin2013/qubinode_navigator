...
All scripts located in: `/root/qubinode_navigator/airflow/scripts/`
...
2. Make executable: `chmod +x test-my-feature.sh`
3. Edit 3 sections: configuration, test logic, DAG example
4. Test it: `./test-my-feature.sh`
5. Add to README.md
