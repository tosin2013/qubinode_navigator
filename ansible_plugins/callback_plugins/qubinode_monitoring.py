...
class CallbackModule(CallbackBase):
    ...
    def _log_event(self, event_type, data):
        ...
        if self.enable_ai_analysis and event_type in [
            "task_failed",
            "deployment_failed",
            "critical_error",
        ]:
    ...
    def _send_to_ai_assistant(self, log_entry):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                self._log_event(
                    "ai_analysis",
                    {"original_event": log_entry, "ai_response": ai_response},
                )
    ...
    def v2_playbook_on_play_start(self, play):
        ...
        self._display.display(f"📋 Starting play: {self.current_play}", color="blue")
    ...
    def v2_runner_on_failed(self, result, ignore_errors=False):
        ...
        self._display.display(f"❌ Task failed: {task_name} on {host}", color="red")
    ...
    def v2_runner_on_unreachable(self, result):
        ...
        unreachable_data = {"host": host, "msg": to_text(result._result.get("msg", ""))}

        self._display.display(f"🔌 Host unreachable: {host}", color="red")
