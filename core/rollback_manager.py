...
from core.rollout_pipeline import PipelineStage, RolloutPhase, RolloutPipeline
...
class RollbackManager:
    ...
    def _serialize_rollback(self, rollback: RollbackPlan) -> Dict[str, Any]:
        ...
        return {
            ...
            "started_at": (
                rollback.started_at.isoformat() if rollback.started_at else None
            ),
            "completed_at": (
                rollback.completed_at.isoformat() if rollback.completed_at else None
            ),
    ...
    async def _validate_rollback_success(self, rollback_plan: RollbackPlan) -> bool:
        ...
        try:
            ...
            validation_results["service_availability"] = (
