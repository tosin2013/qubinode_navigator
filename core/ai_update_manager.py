...
from core.compatibility_manager import CompatibilityLevel, CompatibilityManager
...
class AIUpdateManager:
    ...
    async def analyze_update_with_ai(self, update_info: UpdateInfo) -> AIAnalysis:
        ...
        try:
            ...
            compatibility_level, compatibility_reason = (
...
"""
    ...
    def _create_fallback_analysis(
        ...
        return AIAnalysis(
            ...
            security_impact=(
                "Security impact assessed based on advisories"
                if update_info.security_advisories
    ...
    async def generate_update_report(self, batch_id: str) -> Dict[str, Any]:
        ...
        batch_analyses = {
            ...
            if analysis.analysis_id.startswith(f"ai_analysis_")
