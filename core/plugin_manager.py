...
class PluginManager:
    ...
    def _load_plugin_module(self, py_file: Path, base_dir: str) -> None:
        ...
        try:
            ...
            for name, obj in inspect.getmembers(module, inspect.isclass):
                if (issubclass(obj, QubiNodePlugin) and 
                    obj != QubiNodePlugin and
    ...
    def execute_plugin(self, plugin_name: str, context: ExecutionContext) -> PluginResult:
        ...
        try:
            ...
            self.event_system.emit('plugin_execution_complete', {
    ...
    def execute_plugins(self, 
                       ...
                       context: ExecutionContext = None) -> Dict[str, PluginResult]:
        """
