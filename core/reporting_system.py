...
class ReportingSystem:
    ...
    def _load_report_templates(self) -> Dict[str, Dict[str, Any]]:
        ...
        return {
            ...
            'operational_dashboard': {
                ...
                'sections': ['success_metrics', 'performance_metrics', 'alert_statistics', 'trends'],
                'format': 'detailed',
                'frequency': 'daily'
            },
            'technical_analysis': {
                ...
                'sections': ['performance_metrics', 'failure_analysis', 'component_analysis', 'recommendations'],
                'format': 'detailed',
                'frequency': 'monthly'
            },
    ...
    def _extract_kpis(self, summary_report: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            'active_alerts': {
                ...
                'unit': 'alerts',
                'trend': 'neutral',
                'status': self._get_status_color(summary_report['alert_statistics']['active_alerts'], 2, 5, reverse=True)
            },
            'throughput': {
    ...
    def _get_status_color(self, value: float, good_threshold: float, warning_threshold: float, reverse: bool = False) -> str:
    ...
    def _generate_chart_data(self, summary_report: Dict[str, Any], detailed_report: Dict[str, Any]) -> Dict[str, Any]:
        ...
        charts = {
            ...
            'status_distribution': {
                ...
                'data': [
                    {'label': 'Successful', 'value': summary_report['success_metrics']['successful_deployments'], 'color': '#28a745'},
                    {'label': 'Failed', 'value': summary_report['success_metrics']['failed_deployments'], 'color': '#dc3545'},
                    {'label': 'Rolled Back', 'value': summary_report['success_metrics']['rolled_back_deployments'], 'color': '#ffc107'}
                ]
            },
    ...
    def generate_report(self, report_type: str, time_range: TimeRange = TimeRange.LAST_30D,
