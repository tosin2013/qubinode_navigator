...
## layout: default title: ADR-0007 Bash-First Orchestration parent: Configuration & Automation grand_parent: Architectural Decision Records nav_order: 7
...
1. **Pure Python approach** - Would alienate system administrators familiar with shell scripting
1. **Ansible-only automation** - Insufficient for complex system setup and package management
1. **Go or Rust single binary** - Would require significant rewrite and learning curve
1. **Node.js with shell integration** - Less familiar to target audience of system administrators
...
1. **Python Configuration**: Generate and validate configuration files
1. **Bash Execution**: Execute system commands based on Python-generated configs
1. **Python Validation**: Verify system state and configuration consistency
