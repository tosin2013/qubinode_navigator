---
layout: default
title: ADR-0043 Airflow Container Host Network Access
...
2. **Libvirt network**: VMs run on `192.168.122.0/24` (virbr0 bridge)
3. **Network isolation**: No routing exists between these networks by default
