...
## layout: default title:  Configure Onedev Agent parent: Developer Documentation nav_order: 1
...
1. The script will download and extract the agent package from the specified URL.
1. It will then update the `serverUrl` in the `agent.properties` file with the provided IP address.
