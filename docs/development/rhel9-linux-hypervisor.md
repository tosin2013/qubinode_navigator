...
## layout: default title:  Rhel9 Linux Hypervisor parent: Developer Documentation nav_order: 1
...
1. The script sets the `OLLAMA_API_BASE` environment variable by appending a line to the `~/.bashrc` file.
...
1. Comment code thoroughly to explain complex logic or algorithms
1. Test changes thoroughly before committing them to the main branch
