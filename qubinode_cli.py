...
def execute_plugins(plugin_manager: PluginManager, config_manager: ConfigManager, 
                   plugin_names: list = None, inventory: str = "localhost"):
    """Execute plugins"""
...
def main():
    ...
    ask_parser.add_argument(
        'question',
        nargs='+',
        help='Question to ask the AI Assistant'
    )
    ask_parser.add_argument(
        '--port',
        type=int,
