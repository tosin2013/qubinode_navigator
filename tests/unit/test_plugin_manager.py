...
from core.base_plugin import QubiNodePlugin, PluginResult, ExecutionContext, PluginStatus, SystemState
...
class MockPlugin(QubiNodePlugin):
    ...
    def apply_changes(self, current_state: SystemState, desired_state: SystemState, context: ExecutionContext) -> PluginResult:
        """Apply mock changes"""
        return PluginResult(
            changed=True,
            message="Mock changes applied",
