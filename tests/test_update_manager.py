...
from core.update_manager import UpdateDetector, UpdateInfo, UpdateBatch, CompatibilityMatrix
...
podman.x86_64                    5.0.1-1.el10                     appstream
    ...
    async def test_detect_apt_updates(self, mock_run):
        ...
        mock_run.side_effect = [
            ...
            mock.MagicMock(returncode=0, stdout="Listing...\nkernel-image/focal-updates 5.15.0-91 amd64 [upgradable from: 5.15.0-90]")  # apt list
        ]
