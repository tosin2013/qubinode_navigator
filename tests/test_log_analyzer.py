...
from core.log_analyzer import LogAnalyzer, LogEntry, DeploymentSession, ErrorPattern, ResolutionRecommendation
    ...
    def setup_method(self):
        ...
        self.sample_logs = [
            ...
            },
            {
                ...
                "data": {"task_name": "Install packages", "host": "localhost", "duration": 2.3}
            },
            {
