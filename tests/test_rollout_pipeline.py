...
from core.pipeline_executor import ExecutionResult, PhaseExecution, PipelineExecutor
...
class TestPipelineExecutor:
    ...
    def setup_method(self):
        """Setup test environment"""
        self.config = {"max_concurrent_phases": 2, "phase_timeout_minutes": 60}
