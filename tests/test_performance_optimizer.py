...
from core.performance_optimizer import (
    PerformanceOptimizer, PerformanceMetrics, OptimizationRecommendation,
    ResourceLimit, OptimizationLevel, ResourceType
)
...
class TestPerformanceOptimizer:
    ...
    def test_update_resource_usage(self):
        ...
        metrics = PerformanceMetrics(
            ...
            memory_usage=80.0,
            disk_usage=65.0,
            network_io={'bytes_sent': 1024, 'bytes_recv': 2048, 'packets_sent': 10, 'packets_recv': 20},
            disk_io={'read_bytes': 4096, 'write_bytes': 8192, 'read_count': 5, 'write_count': 10},
            process_count=150,
            load_average=[1.5, 1.2, 1.0],
            response_times={'api_response': 0.1, 'database_query': 0.05, 'file_operation': 0.02}
        )
    ...
    def test_cleanup_old_metrics(self):
        ...
        old_metric = PerformanceMetrics(
            ...
            network_io={}, disk_io={}, process_count=100,
            load_average=[1.0, 1.0, 1.0], response_times={}
        )
        
        new_metric = PerformanceMetrics(
            timestamp=datetime.now(),
            cpu_usage=70.0, memory_usage=80.0, disk_usage=60.0,
            network_io={}, disk_io={}, process_count=120,
            load_average=[1.2, 1.1, 1.0], response_times={}
        )
    ...
    async def test_evaluate_optimization_opportunities(self):
        ...
        high_cpu_metrics = PerformanceMetrics(
            ...
            network_io={}, disk_io={}, process_count=200,
            load_average=[3.0, 2.5, 2.0], response_times={}
        )
    ...
    async def test_optimize_http_requests(self):
        ...
        with mock.patch('aiohttp.ClientSession') as mock_session:
            ...
            requests = [
                ...
                {"method": "POST", "url": "http://example.com/api/2", "data": {"key": "value"}}
            ]
    ...
    def test_get_performance_summary_with_data(self):
        ...
        for i in range(5):
            metric = PerformanceMetrics(
                ...
                memory_usage=60.0 + i,
                disk_usage=40.0 + i,
                network_io={}, disk_io={}, process_count=100 + i,
                load_average=[1.0, 1.0, 1.0], response_times={}
            )
    ...
    def test_get_resource_status(self):
        ...
        limit = ResourceLimit(
            ...
            soft_limit=70.0, hard_limit=85.0,
            current_usage=50.0,
            threshold_warning=60.0, threshold_critical=80.0
        )
    ...
    def test_get_optimization_recommendations(self):
        ...
        rec1 = OptimizationRecommendation(
            ...
            resource_type=ResourceType.CPU,
            current_value=90.0, recommended_value=70.0,
            impact_level="high",
        ...
        rec2 = OptimizationRecommendation(
            ...
            current_value=80.0, recommended_value=70.0,
            impact_level="medium",
