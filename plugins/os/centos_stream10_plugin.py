    ...
    **DEVELOPMENT ADVANTAGE**: Running natively on CentOS Stream 10 provides
    ...
    def _initialize_plugin(self) -> None:
        ...
        self.packages = self.config.get('packages', [
            'bzip2-devel', 'libffi-devel', 'wget', 'vim', 'podman',
            'ncurses-devel', 'sqlite-devel', 'firewalld', 'make', 'gcc',
            'git', 'unzip', 'sshpass', 'lvm2', 'python3', 'python3-pip',
            'java-21-openjdk-devel',  # Java 21 LTS for next-gen
            'ansible-core', 'perl-Digest-SHA',
            'container-tools', 'buildah', 'skopeo',  # Modern container stack
            'python3-devel', 'python3-setuptools'  # Python 3.12 development
        ])
    ...
    def _validate_x86_64_v3_microarchitecture(self) -> None:
        ...
        try:
            ...
            required_flags = [
                'avx', 'avx2', 'bmi1', 'bmi2', 'f16c', 'fma', 'abm', 'movbe'
            ]
