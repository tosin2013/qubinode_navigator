...
class TestEnhancedAIServiceInitialization:
    ...
    async def test_initialize_cloud_only_mode(self, mock_config):
        ...
        with patch("enhanced_ai_service.ModelManager") as mock_mm:
            mock_mm.return_value.get_model_info.return_value = {"model_type": "gpt-4", "preset_info": {}, "max_tokens": 512, "temperature": 0.7}
    ...
    async def test_initialize_api_model_invalid_config(self, mock_config):
        ...
        with patch("enhanced_ai_service.ModelManager") as mock_mm:
            ...
            mock_mm.return_value.validate_configuration.return_value = {"valid": False, "errors": ["Missing API key"], "warnings": []}
    ...
    async def test_initialize_local_model_invalid_config(self, mock_config):
        ...
        with patch("enhanced_ai_service.ModelManager") as mock_mm:
            ...
            mock_mm.return_value.validate_configuration.return_value = {"valid": False, "errors": ["Model file not found"], "warnings": []}
    ...
    async def test_initialize_with_warnings(self, mock_config):
        ...
        with patch("enhanced_ai_service.ModelManager") as mock_mm:
            ...
            mock_mm.return_value.validate_configuration.return_value = {"valid": True, "errors": [], "warnings": ["GPU not available, using CPU"]}
