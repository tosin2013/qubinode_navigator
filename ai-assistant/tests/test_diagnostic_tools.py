...
from diagnostic_tools import (
    DiagnosticTool, ToolResult, SystemInfoTool, ResourceUsageTool,
    ServiceStatusTool, ProcessInfoTool, KVMDiagnosticTool,
    NetworkDiagnosticTool, DiagnosticToolRegistry, diagnostic_registry
)
...
class TestServiceStatusTool:
    ...
    async def test_service_status_execution(self):
        ...
        expected_services = ["libvirtd", "qemu-kvm", "NetworkManager", "firewalld", "sshd"]
...
class TestKVMDiagnosticTool:
    ...
    async def test_kvm_diagnostics_execution(self):
        ...
        possible_keys = [
            "kvm_module_loaded", "kvm_intel_loaded", "kvm_amd_loaded",
            "vmx_support", "svm_support", "libvirt_available", "vm_count"
        ]
...
class TestDiagnosticToolRegistry:
    ...
    def test_registry_initialization(self):
        ...
        expected_tools = [
            "system_info", "resource_usage", "service_status",
            "process_info", "kvm_diagnostics", "network_diagnostics"
        ]
