...
from core.update_manager import UpdateDetector, UpdateBatch, UpdateInfo
...
Examples:
  ...
  python3 ai_update_manager.py recommend --approval-threshold 0.8
    ...
    parser.add_argument(
        '--no-ai',
        action='store_true',
        help='Disable AI analysis (use fallback logic)'
    )
    ...
    analyze_parser.add_argument(
        '--max-updates',
        type=int,
        help='Maximum updates to analyze'
    )
    analyze_parser.add_argument(
        '--format',
    ...
    plan_parser.add_argument(
        '--max-updates',
        type=int,
        help='Maximum updates to include in plan'
    )
    plan_parser.add_argument(
        '--approval-threshold',
        type=float,
