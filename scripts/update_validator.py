...
from core.update_validator import UpdateValidator, ValidationStage, ValidationResult
...
Examples:
  ...
  python3 update_validator.py cleanup
    ...
    parser.add_argument(
        ...
        type=int,
        default=3,
        help='Maximum parallel tests (default: 3)'
    )
    ...
    # List command
    list_parser = subparsers.add_parser('list', help='List available tests and environments')
