...
from core.monitoring_manager import MonitoringManager, AlertSeverity, MetricType
...
Examples:
  ...
  python monitoring_manager.py stats --format json
    ...
    alerts_parser.add_argument('--status', choices=['active', 'resolved', 'all'], default='active',
    ...
    alerts_parser.add_argument('--format', choices=['table', 'json'], default='table',
                              help='Output format')
    ...
    create_alert_parser.add_argument('--severity', choices=['info', 'warning', 'error', 'critical'],
    ...
    test_parser.add_argument('--component', choices=['alerts', 'metrics', 'rules'], 
                            default='alerts', help='Component to test')
